...
setup(
    ...
    extras_require={
        "test": [
            'pytest>=7.4.0,<8.0.0;python_version<"3.10"',
            'pytest>=9.0.0,<10.0.0;python_version>="3.10"',
            "docker==7.1.0",
            "backoff",
            "psycopg2-binary",
            'pytest-asyncio>=0.21.0,<0.22.0;python_version<"3.10"',
            'pytest-asyncio>=1.3.0,<2.0.0;python_version>="3.10"',
            "pytest-cov",
            "coverage>=4.0.3",
            "pytest-docker-fixtures==1.4.2",
            'pytest-rerunfailures>=12.0,<13.0;python_version<"3.10"',
            'pytest-rerunfailures>=16.3,<17.0;python_version>="3.10"',
