...
setup(
    ...
    install_requires=[
        "uvicorn>=0.33.0,<0.40; python_version < '3.10'",
        "uvicorn==0.40.0; python_version >= '3.10'",
        "websockets",
        "jsonschema>=4.23.0,<4.24; python_version < '3.10'",
        ...
        "asyncpg",
        "cffi>=1.17.1,<2.0; python_version < '3.9'",
        "cffi>=2.0.0; python_version >= '3.9'",
        "PyYAML>=5.1",
        "lru-dict",
        "mypy_extensions",
        "argon2-cffi>=23.1.0,<25.1.0; python_version < '3.8'",
        "argon2-cffi>=25.1.0; python_version >= '3.8'",
        "backoff",
        "multidict",
        "typing_extensions>=4.13.0,<4.14; python_version < '3.9'",
