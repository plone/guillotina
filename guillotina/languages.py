...
_combinedlanguagelist = {
    ...
    "cs-cz": {"name": "Czech (Czech republic)", "native": "Čeština (Česká republika)"},
    ...
    "pt-ao": {"name": "Portuguese (Angola)", "native": "Português (Angola)"},
    "pt-br": {"name": "Portuguese (Brazil)", "native": "Português (Brasil)"},
    "pt-cv": {"name": "Portuguese (Ilhas Cabo Verde)", "native": "Português (Cabo Verde)"},
    ...
    "zh-cn": {"name": "Chinese (China)", "native": "简体中文(中国)"},
    "zh-hk": {"name": "Chinese (Hongkong)", "native": "繁體中文(香港)"},
    "zh-sg": {"name": "Chinese (Singapore)", "native": "简体中文(新加坡)"},
    "zh-tw": {"name": "Chinese (Taiwan)", "native": "繁體中文(臺灣)"},
}
