...
from guillotina.utils import get_content_depth, get_content_path
...
@directives.index_field.with_accessor(IResource, "access_users", type="keyword", fields=["acl"])
...
def get_parent_uuid(ob):
    if hasattr(ob, "__parent__") and ob.__parent__ is not None:
