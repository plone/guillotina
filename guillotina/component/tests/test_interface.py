...
class Test_getInterface(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import getInterface
...
class Test_queryInterface(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import queryInterface
...
class Test_searchInterface(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import searchInterface
...
class Test_searchInterfaceIds(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import searchInterfaceIds
...
class Test_searchInterfaceUtilities(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import searchInterfaceUtilities
...
class Test_getInterfaceAllDocs(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import getInterfaceAllDocs
...
class Test_nameToInterface(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import nameToInterface
...
class Test_interfaceToName(unittest.TestCase):
    ...
    def _callFUT(self, *args, **kw):
        from guillotina.component.interface import interfaceToName
