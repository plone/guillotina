...
class Test_read_property(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from guillotina.component.hooks import read_property
...
class SiteInfoTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from guillotina.component.hooks import SiteInfo
        return SiteInfo
...
class Test_setSite(unittest.TestCase):
    ...
    def _callFUT(self, site):
        from guillotina.component.hooks import setSite
        return setSite(site)
...
class Test_getSite(unittest.TestCase):
    ...
    def _callFUT(self):
        from guillotina.component.hooks import getSite
        return getSite()
...
class Test_site(unittest.TestCase):
    ...
    def _callFUT(self, new_site):
        from guillotina.component.hooks import site
...
class Test_adapter_hook(unittest.TestCase):
    ...
    def _callFUT(self, interface, object, name='', default=None):
        from guillotina.component.hooks import adapter_hook
...
class Test_setHooks(unittest.TestCase):
    ...
    def _callFUT(self):
        from guillotina.component.hooks import setHooks
        return setHooks()

    def test_it(self):
        import guillotina.component._api
        from guillotina.component import hooks
        class _Hook(object):
            def __init__(self):
                self._hooked = None
...
class Test_resetHooks(unittest.TestCase):
    ...
    def _callFUT(self):
        from guillotina.component.hooks import resetHooks
        return resetHooks()
