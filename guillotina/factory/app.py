...
def make_app(config_file=None, settings=None):
    ...
    configure.scan('guillotina.auth.checker')
    configure.scan('guillotina.auth.security_local')
    configure.scan('guillotina.auth.policy')
    ...
    configure.scan('guillotina.file')
