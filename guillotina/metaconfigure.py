...
def contenttype_directive(_context, portal_type, class_, schema, behaviors=None,
    ...
    """
    logger.warn('guillotina:contenttype directive will be removed in 1.0.0 final')
...
def api_directive(_context, file):  # noqa 'too complex' :)
    logger.warn('guillotina:api directive will be removed in 1.0.0 final')
...
def add_on(_context, name, title, handler):
    logger.warn('guillotina:addon directive will be removed in 1.0.0 final')
    from guillotina import app_settings
