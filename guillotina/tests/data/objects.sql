...
INSERT INTO objects VALUES ('DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD', 0, 0, 0, false, NULL, NULL, NULL, NULL, 'TRASH_REF', NULL, NULL);
INSERT INTO objects VALUES ('00000000000000000000000000000000', 1, 64, 0, false, NULL, NULL, NULL, NULL, 'guillotina.db.db.Root', 'null', '\x80049535000000000000008c106775696c6c6f74696e612e64622e6462948c04526f6f749493942981947d948c095f5f64625f69645f5f948c0264629473622e');
...
CREATE INDEX object_id ON objects USING btree (id);
...
CREATE INDEX object_of ON objects USING btree (of);
...
CREATE INDEX object_parent ON objects USING btree (parent_id);
...
CREATE INDEX object_part ON objects USING btree (part);
...
CREATE INDEX object_tid ON objects USING btree (tid);
...
CREATE INDEX object_type ON objects USING btree (type);
