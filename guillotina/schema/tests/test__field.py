...
class BytesTests(unittest.TestCase):
    ...
    def test_fromUnicode_miss(self):
        byt = self._makeOne()
        self.assertRaises(UnicodeEncodeError, byt.fromUnicode, chr(129))
...
class DecimalTests(unittest.TestCase):
    ...
    def test_fromUnicode_miss(self):
        ...
        self.assertRaises(ValueError, flt.fromUnicode, '')
        self.assertRaises(ValueError, flt.fromUnicode, 'abc')
        self.assertRaises(ValueError, flt.fromUnicode, '1.4G')
...
class ChoiceTests(unittest.TestCase):
    ...
    def test_fromUnicode_miss(self):
        ...
        self.assertRaises(ConstraintNotSatisfied, flt.fromUnicode, '1.4G')
