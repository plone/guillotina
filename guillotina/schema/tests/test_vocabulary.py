...
class SimpleVocabularyTests(unittest.TestCase):
    ...
    def test_nonunique_tokens(self):
        ...
        self.assertRaises(ValueError, klass.fromItems, [(1, "one"), ("1", "another one")])
        self.assertRaises(ValueError, klass.fromItems, [(0, "one"), (1, "one")])
...
class TreeVocabularyTests(unittest.TestCase):
    ...
    def tree_vocab_2(self):
        region_tree = {
            ("regions", "Regions"): {
                ("aut", "Austria"): {("tyr", "Tyrol"): {("auss", "Ausserfern"): {}}},
                ("ger", "Germany"): {("bav", "Bavaria"): {}},
            }
        }
    ...
    def business_tree(self):
        return {
            ("services", "services", "Services"): {
                ...
                ("check_in", "check_in", "Check-in"): {("dcs_host", "dcs_host", "DCS Host"): {}},
            },
    ...
    def test_implementation(self):
        ...
        from guillotina.schema.interfaces import ITreeVocabulary, IVocabulary, IVocabularyTokenized
    ...
    def test_contains(self):
        tv2 = self.tree_vocab_2()
        self.assertTrue("Regions" in tv2 and "Austria" in tv2 and "Bavaria" in tv2)
        ...
        tv3 = self.tree_vocab_3()
        self.assertTrue("database" in tv3 and "security" in tv3 and "services" in tv3)
    ...
    def test_nonunique_values_and_tokens(self):
        ...
        self.assertRaises(
            ...
            {("new_york", "New York"): {("albany", "Albany"): {}, ("new_york", "New York"): {}}},
        )
        # The same applies to nested values.
        self.assertRaises(
            ValueError,
            self._getTargetClass().fromDict,
            {("1", "new_york"): {("2", "albany"): {}, ("3", "new_york"): {}}},
        )
        ...
        self._getTargetClass().fromDict({("one", "1", "One"): {}, ("two", "2", "One"): {}})

    def test_nonunique_value_message(self):
        try:
            self._getTargetClass().fromDict({("one", "1"): {}, ("two", "1"): {}})
        except ValueError as e:
            self.assertEqual(str(e), "Term values must be unique: '1'")

    def test_nonunique_token_message(self):
        try:
            self._getTargetClass().fromDict({("one", "1"): {}, ("one", "2"): {}})
        except ValueError as e:
...
class RegistryTests(unittest.TestCase):
    ...
    def test_setVocabularyRegistry(self):
        from guillotina.schema.vocabulary import getVocabularyRegistry, setVocabularyRegistry
