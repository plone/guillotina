...
# override some views...
configure.service(context=IGroupManager, method="POST", permission="guillotina.AddGroup")(DefaultPOST)


@configure.service(context=IUserManager, method="POST", permission="guillotina.AddUser")
